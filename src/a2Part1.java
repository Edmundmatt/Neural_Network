...
public class a2Part1 {
    ...
    public static void main(String[] _ignored) {
        ...
        //train(double[][] instances, int[] desired_outputs, int epochs)
        //Desired outputs is a list of integers, one for each instance
        //Create new [][] containing just the first instance
        double[][] firstInstance = new double[1][instances[0].length];
        firstInstance[0] = instances[0];
//        nn.train(firstInstance, integer_encoded, 100);
